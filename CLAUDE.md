...
| **[Theme System](./docs-internal/theme_system.md)** | 4-way visual theme system (light / dark / renaissance / cyber) driven by `<html data-theme>` + per-theme CSS files in `client/src/themes/`. Token taxonomy (surface / fg / border / accent / typography / motion), migration recipe, anti-patterns, file index. Read this before adding a new theme or migrating a component to the new contract. |
